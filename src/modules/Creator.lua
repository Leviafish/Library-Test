		...
		for Property, ColorKey in pairs(objData.Properties or {}) do
			...
			if value ~= nil then
				...
				elseif typeof(value) == "table" and value.Color and value.Transparency then
					...
					gradient.Rotation     = value.Rotation or 0  -- always force, prevents stale rotation on theme switch
					for prop, propValue in pairs(value) do
						if prop ~= "Color" and prop ~= "Transparency" and prop ~= "Rotation" and gradient[prop] ~= nil then
