return function(Creator)
	return {
		...
		Checkbox = "Button",  -- Leviathan: use Button gradient for Checkbox
		CheckboxIcon = "White",
		...
		Slider = "Button",    -- Leviathan: use Button gradient for Slider
		SliderThumb = "White",
		SliderIconFrom = "SliderIcon",
		SliderIconTo = "SliderIcon",

		ProgressBar = "Button", -- Leviathan: use Button gradient for ProgressBar
		...
		TooltipText = "White",
		TooltipSecondary = "Button", -- Leviathan: consistent with Button
