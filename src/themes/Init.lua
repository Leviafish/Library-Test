...
return function(WindUI, Creator)
	...
	return {
		...
		Leviathan = {
			...
			-- ── Core palette ─────────────────────────────────────────────
			-- Deep Navy → Ocean Blue → Ice Blue → White-Blue
			-- All gradient: 5-stop spectrum across the entire UI

			Background = WindUI:Gradient({
				["0"]   = { Color = Color3.fromHex("#010812"), Transparency = 0 },
				["25"]  = { Color = Color3.fromHex("#001428"), Transparency = 0 },
				["50"]  = { Color = Color3.fromHex("#002244"), Transparency = 0 },
				["75"]  = { Color = Color3.fromHex("#003366"), Transparency = 0 },
			...
			Dialog = WindUI:Gradient({
				["0"]   = { Color = Color3.fromHex("#000e1e"), Transparency = 0 },
				["50"]  = { Color = Color3.fromHex("#001e3c"), Transparency = 0 },
				["100"] = { Color = Color3.fromHex("#00284f"), Transparency = 0 },
			}, { Rotation = 135 }),

			-- Button: Ocean → Ice → White-Blue — full spectrum
			Button = WindUI:Gradient({
				["0"]   = { Color = Color3.fromHex("#0055cc"), Transparency = 0 },
				["30"]  = { Color = Color3.fromHex("#0077ee"), Transparency = 0 },
				["55"]  = { Color = Color3.fromHex("#00aaff"), Transparency = 0 },
				["80"]  = { Color = Color3.fromHex("#55ccff"), Transparency = 0 },
				["100"] = { Color = Color3.fromHex("#aae0ff"), Transparency = 0 },
			}, { Rotation = 45 }),

			-- Toggle / Slider / Checkbox: same family, slightly tighter range
			Toggle = WindUI:Gradient({
				["0"]   = { Color = Color3.fromHex("#0077ee"), Transparency = 0 },
				["50"]  = { Color = Color3.fromHex("#00aaff"), Transparency = 0 },
				["100"] = { Color = Color3.fromHex("#55ccff"), Transparency = 0 },
			}, { Rotation = 45 }),
