...
return function(Config)
	...
	function Window:Open()
		...
		task.spawn(function()
			...
			-- Leviathan: premium spring open — scale+size reveal
			Window.UIElements.Main.Size = UDim2.new(Window.Size.X.Scale, Window.Size.X.Offset, 0, 48)
			if not Window.UIElements.Main:FindFirstChild("LevScale") then
				local sc = Instance.new("UIScale"); sc.Scale = 0.82; sc.Name = "LevScale"
				sc.Parent = Window.UIElements.Main
			end
			Window.UIElements.Main.LevScale.Scale = 0.82

			Tween(Window.UIElements.Main, 0.48, {
				Size = Window.Size,
			}, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out):Play()
			Tween(Window.UIElements.Main.LevScale, 0.44, {
				Scale = 1,
			}, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out):Play()
	...
	function Window:Close()
		...
		-- Leviathan: premium close — quick scale shrink then snap shut
		if Window.UIElements.Main:FindFirstChild("LevScale") then
			Tween(Window.UIElements.Main.LevScale, 0.15, {
				Scale = 0.88,
			}, Enum.EasingStyle.Quint, Enum.EasingDirection.In):Play()
		end
		task.delay(0.06, function()
			Tween(Window.UIElements.Main, 0.30, {
				Size = UDim2.new(Window.Size.X.Scale, Window.Size.X.Offset, 0, 0),
			}, Enum.EasingStyle.Quint, Enum.EasingDirection.In):Play()
		end)
		if Window.UIElements.BackgroundGradient then
