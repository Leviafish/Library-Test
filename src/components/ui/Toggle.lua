...
function Toggle.New(Value, Icon, IconSize, Parent, Callback, NewElement, Config)
	...
	function Toggle:Animate(input, ToggleObj)
		...
		Tween(ToggleFrame.Frame.Bar.UIScale, 0.18, { Scale = 1.6 },
			Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
		Tween(ToggleFrame.Frame.Bar.Highlight.BarOverlay, 0.18, { ImageTransparency = 0.78 }):Play()
		...
		endConnection = UserInputService.InputEnded:Connect(function(inp)
			...
			Tween(ToggleFrame.Frame.Bar.UIScale, 0.22, { Scale = 1 },
